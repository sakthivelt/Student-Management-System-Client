        ...
        {activeStep === steps.length ? (
          <div style={{width:'100%',height:'360px'}}>
            <div style={{width:'100%',height:'100%',display:'flex',flexDirection:'column',justifyContent:'space-evenly',alignItems:'center'}}>
              {Animation==true&&<Loader/>}
              {Animation===false&&(Animation||OldUser===true||RegNo===""?<Warning/>:<Success/>)}
              {Animation===false&&(!Animation&&OldUser===true&&<h3>User already Existing</h3>)}
              {serverStatus==false&&<h3>Server ERROR</h3>}
          ...
          <div>
            ...
            <div  style={{marginRight:'300px'}}>
              ...
              <Button
                variant="contained"
                color="primary"
                onClick={()=>{Degree===""||RegNo===""?alert("please fill out the required feilds"):handleNext()}}
